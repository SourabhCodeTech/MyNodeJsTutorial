        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pin flex space-x-2 mt-6">
                <input
                  onChange={onChangePin}
                  placeholder="Enter Your Pincode"
                  type="text"
                  className=" '     ' ? 'border-black' : 'border-gray-300'polor ===} outline-none border-pink-500 rounded-[4px]"
                />
                <button
              ...
              {!service && service != null && (
                <div className="text-red-700 text-sm mt-6">
                  Sorry! We do not deliver to this pincode yet.
                </div>
              )}
              {service && service != null && (
                <div className="text-green-700 text-sm mt-6">
